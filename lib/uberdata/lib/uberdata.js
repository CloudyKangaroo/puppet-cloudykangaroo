...
function storeUberData(body, key) {
  ...
  switch (key)
  {
    case 'device.list':
      ...
      console.log('Storing device list secondary indexes completed.')
      ...
      redisClient.set('device.list.location', JSON.stringify(deviceListbyLocation));
      break;
    default:
      break;
  }
...
function StoreSecondaryIndex(itemList, key, index) {
  var listByKey = {};
