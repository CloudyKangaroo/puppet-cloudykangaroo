...
$.extend(true, $.fn.dataTable.defaults, {
  "sDom": "<'row'<'col-xs-5 col-sm-6'l><'col-xs-7 col-sm-6 text-right'f>r>t<'row'<'col-xs-3 col-sm-4 col-md-5 col-lg-5'i><'col-xs-9 col-sm-8 col-md-7 col-lg-7 text-right'p>>",
  ...
  "fnInitComplete": function (oSettings, json) {
    ...
    if (currentId) {
      ...
      thisLengthLabel.addClass('control-label col-xs-12 col-sm-7 col-md-6 col-lg-6').attr('for', currentId + '_length_select').css('text-align', 'left');
      thisLengthSelect.addClass('form-control input-sm').attr('id', currentId + '_length_select');
      thisLengthSelect.prependTo(thisLength).wrap('<div class="col-xs-12 col-sm-5 col-md-6 col-lg-6" />');
      ...
      thisFilterInput.appendTo(thisFilter).wrap('<div class="col-xs-8 col-sm-9 col-md-9 col-lg-9 " />');
    }
  }
});
