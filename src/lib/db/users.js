...
var defaultUser = { id: '0', name: 'Development User', username: 'development.user', type:'admin', emails: [{name: 'primary', value: 'development.user@contegix.com'}], groups: ['users', 'engineers', 'devops', 'sales']};
...
exports.syncfindByUsername = function (username) {
  "use strict";
  var retUser = null;
